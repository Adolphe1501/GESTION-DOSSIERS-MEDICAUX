...
<div class="row justify-content-center py-4 mx-0">
    <div class="col-sm-6">
        <div class="card card-body shadow-sm">
            <form method="post" action="index.php?page=controllers/add-drh-controller" class="needs-validation" novalidate>
                <div class="text-center my-4">
                    <span class="h3 font-weight-bold text-secondary">AJOUTER UN DRH </span>
                </div>
                <div class="row my-4">
                ...
                <div class="row justify-content-center">
                    <button type="submit" name="submit_drh" class="btn btn-secondary col-md-4">ajouter</button>
                </div>
